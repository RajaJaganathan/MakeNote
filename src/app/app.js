var MakeNoteApp = angular.module("MakeNoteApp", ['ngRoute', 'ngAnimate', 'NoteApp', 'AboutusApp', 'HelpApp']);
...
MakeNoteApp.run(['$rootScope', function ($root) {
...
MakeNoteApp.config(function ($routeProvider) {
    $routeProvider.
      when('/', {
